/****************************************************************************
** Meta object code from reading C++ file 'ordertable_widget.h'
**
...
#include "panel/product_panel/ordertable_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ordertable_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 10), // "updateLine"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3), // "row"
QT_MOC_LITERAL(4, 33, 13) // "on_updateData"

    },
    "OrderTableWidget\0updateLine\0\0row\0"
    "on_updateData"
};
...
void OrderTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OrderTableWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject OrderTableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_OrderTableWidget.data,
    qt_meta_data_OrderTableWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
