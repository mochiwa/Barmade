...
public:
    ...
    void setupUi(QWidget *OrderWidget)
    {
        ...
        OrderWidget->resize(435, 442);
        verticalLayout = new QVBoxLayout(OrderWidget);
        verticalLayout->setSpacing(2);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        frame_info = new QFrame(OrderWidget);
        ...
        frame_table = new QFrame(OrderWidget);
        ...
        frame_total = new QFrame(OrderWidget);
    ...
    {
        OrderWidget->setWindowTitle(QApplication::translate("OrderWidget", "Form", nullptr));
        label_date->setText(QApplication::translate("OrderWidget", "Date: ", nullptr));
        label_employee->setText(QApplication::translate("OrderWidget", "Employee:", nullptr));
        label_date_value->setText(QString());
        label_employee_value->setText(QString());
        label_total->setText(QApplication::translate("OrderWidget", "Total :", nullptr));
        spinbox_total->setPrefix(QString());
        spinbox_total->setSuffix(QApplication::translate("OrderWidget", "$", nullptr));
    } // retranslateUi

};

namespace Ui {
    class InvoiceWidget: public Ui_OrderWidget {};
} // namespace Ui
