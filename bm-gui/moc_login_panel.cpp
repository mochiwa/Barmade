/****************************************************************************
** Meta object code from reading C++ file 'login_panel.h'
**
...
#include "panel/login_panel/login_panel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'login_panel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 14), // "user_connected"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 23), // "on_button_login_clicked"
QT_MOC_LITERAL(4, 51, 8), // "Employee"
QT_MOC_LITERAL(5, 60, 4), // "user"
QT_MOC_LITERAL(6, 65, 14) // "error_detected"

    },
    "LoginPanel\0user_connected\0\0"
    "on_button_login_clicked\0Employee\0user\0"
    "error_detected"
};
...
void LoginPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->user_connected(); break;
        case 1: _t->on_button_login_clicked(); break;
        case 2: _t->user_connected((*reinterpret_cast< Employee(*)>(_a[1]))); break;
        case 3: _t->error_detected(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LoginPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginPanel::user_connected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginPanel::user_connected()
{
